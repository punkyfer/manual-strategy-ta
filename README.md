...
**4.** An empty portfolio and a benchmark portfolio are then created for comparison, the benchmark portfolio buys X amount of the stock on the start date and sells it on the end date of the dataset
